...
open class AbstractHttpStorageBackend @Throws(URISyntaxException::class)
constructor(root: String) {
    protected val httpclient: CloseableHttpClient
    internal var root: URI
    ...
    companion object {
        protected val logger = LoggerFactory.getLogger(AbstractHttpStorageBackend::class.java)
